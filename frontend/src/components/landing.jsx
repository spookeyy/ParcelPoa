        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="/login" className="bg-transparent hover:bg-purple-500 text-purple-700 font-semibold hover:text-white py-2 px-4 rounded-full border border-purple-500 hover:border-transparent">Log In</a>
            </div>
          </nav>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
           <div className="flex flex-col justify-center items-start">
            ...
            <h3 className="text-4xl font-bold text-gray-800 mb-4">Speedy Delivery, Reliable Service</h3>
             ...
             At Parcel Poa, we ensure your packages are delivered swiftly and safely, providing you with peace of mind every time.             </p>
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-center md:justify-start">
              <a href="/create-account" className="bg-transparent hover:bg-purple-500 text-purple-700 font-semibold hover:text-white py-2 px-4 rounded-full border border-purple-500 hover:border-transparent">Get Started</a>
              <a href="/tracking" className="bg-purple-500 text-white font-medium py-2 px-4 rounded-full hover:bg-purple-600">Track Order</a>
            </div>
          </div>
