          ...
          <main className="py-16 px-4 flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div className="flex flex-col justify-center items-start">
                ...
                <h5 className="text-2xl font-bold italic mb-4 text-center md:text-left">
              ...
              <div className="mt-16 md:mt-0 w-full flex justify-center">
                <img
                  src={DeliverPersonel}
                  alt="Delivery Person"
                  className="h- w-auto max-w-full object-contain md:h-auto border border-gray-50 rounded-lg shadow-xl"
                />
              </div>
            </div>
          </main>
