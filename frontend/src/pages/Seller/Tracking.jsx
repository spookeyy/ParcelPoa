            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-blue-600 text-white">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Approved</th>
            ...
            <div className="mt-8 bg-white border border-gray-200 rounded-lg shadow-lg p-6">
              ...
              {detailsLoading ? (
                ...
                <>
                  ...
                  <p><strong>Estimated Delivery Date:</strong> {new Date(orderDetails.estimatedDelivery).toLocaleDateString()}</p>
                  <p><strong>Assigned Agent:</strong> {orderDetails.agentName}</p>
                  <h3 className="mt-6 text-lg font-semibold text-gray-700">Progress:</h3>
                ...
                <p className="text-gray-600">No details available for this order.</p>
              )}
            </div>
          )}
        </>
