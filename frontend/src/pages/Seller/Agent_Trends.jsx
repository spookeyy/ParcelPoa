...
export default function AgentTrends() {
  ...
  if (!agent) {
    return (
      <div className="p-6 text-center text-gray-500">Loading agent data...</div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      <h1 className="text-3xl font-semibold mb-6 border-b border-gray-200 pb-2">
        Agent Trends
      </h1>
      ...
      <div className="mb-8 border-b border-gray-200 pb-6">
        ...
        <p className="text-gray-700 mb-1">
          <strong>Total Deliveries:</strong> {agent.deliveries}
        </p>
        <p className="text-gray-700">
          <strong>Success Rate:</strong> {agent.successRate}%
        </p>
      </div>
